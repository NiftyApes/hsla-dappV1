    ...
    return (
        ...
        >
            <Flex flexDir="column" alignItems="center">
                ...
                <Text fontSize="2xs" color="solid.darkGray">ACTIVE LOANS</Text>
            </Flex>
            <Flex flexDir="column" alignItems="center">
                <Text
                    fontSize="7xl">{activeLoans?.filter((loan: any) => loan.loanEndTimestamp * 1000 < Date.now()).length}</Text>
                <Text fontSize="2xs" color="solid.darkGray">DEFAULTED LOANS</Text>
            </Flex>
            <Flex flexDir="column" alignItems="center">
                ...
                <Text fontSize="2xs" color="solid.darkGray">TOTAL LENT</Text>
            </Flex>
            <Flex flexDir="column" alignItems="center">
                <Flex alignItems="center" justifyContent="center">
                    <CryptoIcon symbol="eth" size={40}/>
            ...
            <Flex flexDir="column" alignItems="center">
                ...
                <Text fontSize="2xs" color="solid.darkGray">LIQUIDITY UTILIZED</Text>
            </Flex>
        </Flex>
    );
};

...
import { NETWORKS, TNetworkNames } from '../lib/constants/networks';
...
const targetNetwork: TNetworkNames = import.meta.env.ENV_APP_TARGET_NETWORK as TNetworkNames;
invariant.log('ENV_APP_TARGET_NETWORK', import.meta.env.ENV_APP_TARGET_NETWORK);
 ...
 */
export const FAUCET_ENABLED = import.meta.env.ENV_FAUCET_ALLOWED === 'true' && import.meta.env.DEV;
/**
 * Use burner wallet as fallback
 */
export const BURNER_FALLBACK_ENABLED =
  import.meta.env.ENV_BURNER_FALLBACK_ALLOWED === 'true' && import.meta.env.DEV;
/**
 * Connect to burner on first load if there are no cached providers
 */
export const CONNECT_TO_BURNER_AUTOMATICALLY =
  import.meta.env.ENV_CONNECT_TO_BURNER_AUTOMATICALLY === 'true' && import.meta.env.DEV;

if (DEBUG)
  invariant.log(
    `import.meta.env.DEV: ${import.meta.env.DEV}`,
    `import.meta.env.ENV_FAUCET_ALLOWED: ${import.meta.env.ENV_FAUCET_ALLOWED}`,
    `import.meta.env.ENV_BURNER_FALLBACK_ALLOWED: ${import.meta.env.ENV_BURNER_FALLBACK_ALLOWED}`,
    `import.meta.env.ENV_CONNECT_TO_BURNER_AUTOMATICALLY: ${
      import.meta.env.ENV_CONNECT_TO_BURNER_AUTOMATICALLY
    }`,
  );
...
const mainnetScaffoldEthProvider = new StaticJsonRpcProvider(import.meta.env.ENV_RPC_MAINNET);
const mainnetInfura = new StaticJsonRpcProvider(
  `${import.meta.env.ENV_RPC_MAINNET_INFURA}/${import.meta.env.ENV_KEY_INFURA}`,
);
// const mainnetProvider = new InfuraProvider("mainnet",import.meta.env.ENV_KEY_INFURA);

// 🚊 your mainnet provider
export const MAINNET_PROVIDER = mainnetScaffoldEthProvider;
export const MAINNET_INFURA_PROVIDER = mainnetInfura;

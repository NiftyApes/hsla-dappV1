...
export interface INiftyApesInterface extends utils.Interface {
  contractName: 'INiftyApes';
  functions: {
...
export interface INiftyApes extends BaseContract {
  contractName: 'INiftyApes';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: INiftyApesInterface;
  ...
  functions: {
    ...
    getOffer(
      ...
      [ILendingStructs.OfferStructOutput] & {
        offer: ILendingStructs.OfferStructOutput;
      }
    >;

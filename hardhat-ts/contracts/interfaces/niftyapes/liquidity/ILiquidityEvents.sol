...
interface ILiquidityEvents {
  ...
  event Erc20Supplied(address indexed liquidityProvider, address indexed asset, uint256 tokenAmount, uint256 cTokenAmount);
  ...
  /// @param cTokenAmount The amount of compound tokens that resulted from this deposit
  event CErc20Supplied(address indexed liquidityProvider, address indexed cAsset, uint256 cTokenAmount);
  ...
  event Erc20Withdrawn(address indexed liquidityProvider, address indexed asset, uint256 tokenAmount, uint256 cTokenAmount);
  ...
  event CErc20Withdrawn(address indexed liquidityProvider, address indexed cAsset, uint256 cTokenAmount);

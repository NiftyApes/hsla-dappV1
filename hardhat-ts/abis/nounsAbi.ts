export const nounsAbi = [
  ...
  { anonymous: false, inputs: [{ indexed: false, internalType: 'address', name: 'noundersDAO', type: 'address' }], name: 'NoundersDAOUpdated', type: 'event' },
  {
    anonymous: false,
    inputs: [
  ...
  { inputs: [{ internalType: 'uint256', name: 'nounId', type: 'uint256' }], name: 'burn', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [
  ...
  { inputs: [], name: 'isDescriptorLocked', outputs: [{ internalType: 'bool', name: '', type: 'bool' }], stateMutability: 'view', type: 'function' },
  { inputs: [], name: 'isMinterLocked', outputs: [{ internalType: 'bool', name: '', type: 'bool' }], stateMutability: 'view', type: 'function' },
  { inputs: [], name: 'isSeederLocked', outputs: [{ internalType: 'bool', name: '', type: 'bool' }], stateMutability: 'view', type: 'function' },
  ...
  { inputs: [], name: 'noundersDAO', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
  {
    inputs: [{ internalType: 'address', name: '', type: 'address' }],
    name: 'numCheckpoints',
  ...
  { inputs: [], name: 'seeder', outputs: [{ internalType: 'contract INounsSeeder', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
  {
